...
public class ErrorHandler {
    ...
    @ExceptionHandler({MethodArgumentNotValidException.class, IncorrectParametersException.class, MethodArgumentTypeMismatchException.class,
    ...
    @ExceptionHandler({PSQLException.class, ClashException.class, DataIntegrityViolationException.class})
